...
export const getLeagueId = (tier, year) => {
...
export const getAllLeagueConfigs = () => {
    return [...LEAGUES].sort((a, b) => {
        if (a.year !== b.year)
            return b.year.localeCompare(a.year);
        const tierOrder = { PREMIER: 0, MASTERS: 1, NATIONAL: 2 };
        return tierOrder[a.tier] - tierOrder[b.tier];
    });
};
export const LEAGUE_HIERARCHY = ['PREMIER', 'MASTERS', 'NATIONAL'];
