...
export class LeagueController {
  ...
  async getAllStandings(req: Request, res: Response) {
    try {
  ...
  async getLeagueStandings(req: Request, res: Response) {
    try {
      ...
      const leagueTier = league.toUpperCase() as LeagueTier;
  ...
  async getWeekMatchups(req: Request, res: Response) {
    try {
  ...
  async getLeagueHistory(req: Request, res: Response) {
    try {
      ...
      const historyByYear: Record<string, any> = {};
